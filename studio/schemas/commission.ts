    ...
    defineField({
      ...
      options: {
        list: [
          ...
          { title: 'In Review (internal QA)', value: 'review' },
          { title: 'Complete (digital — sends download link)', value: 'complete' },
          { title: 'Shipped (print — sends dispatch email)', value: 'shipped' },
